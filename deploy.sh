...
deploygateway() {
  ...
  helm upgrade --install invoice-vs ./gateway/helm --set destination.host.live="invoice-mgr-app-svc.$1.svc.cluster.local" --set destination.host.canary="invoice-mgr-app-svc.$2.svc.cluster.local" --wait
